...
<head>
    ...
    <title>Welcome to Techburg</title>
...
================================================== -->
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Techburg</a>
            </div>
            ...
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated3">
                                <span><strong>Techburg</strong> for the highest</span>
                            </h1>
                ...
                <div class="item">
                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated1">
                    		  <span>Welcome to <strong>Techburg</strong></span>
                    	    </h1>
    ...
    <section class="call-to-action">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>" Welcome to Techburg's Digital Haven,</br>Where Innovation Flourishes and Dreams Become Digital Realities. Explore our World of Possibilities,</br>  Innovate with Confidence, and Let Success Be Your Journey."</h1>
                        ...
                        <ul id="portfolio-list">
                            ...
                            <li>
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-caption">
                                        <h4>StatSociety Organization</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-contact-info">
                        <h4>Contact info</h4>
                        <ul>
                            <li><strong>E-mail :</strong> hello@Techburg</li>
                            <li><strong>Phone :</strong> +255687742082</li>
                            <li><strong>Mobile :</strong> +255687742082</li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <span class="copyright">Copyright &copy; <a href="http://guardiantheme.com">Techburg</a> 2023</span>
                    </div>
                    <div class="col-md-4 col-xs-12">
