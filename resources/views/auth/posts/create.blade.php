              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample"  method="post"  action="{{ route('storedata') }}"  enctype="multipart/form-data">
                    @csrf
                     ...
                     <textarea name="description"  class="form-control" id="" cols="5"  rows="7"  required></textarea>
                        ...
                        {{-- <textarea name="description"  class="form-control" id="description" cols="5"  rows="7"  required   value="{{old('description')}}"></textarea>
                        <label class="col-sm-3 col-form-label">Content</label> --}}
